    ...
    <div className="card CDLaunch Page">
      <div className="Page-subtle-content cdlaunch-content">
        ...
        <div className="cdlaunch-c2">
          <div className="cdlaunch-c2-1 mobile_none">Games & Participation phase</div>
          <div className="cdlaunch-c2-1 desktop_none">Participation phase</div>
          <div className="cdlaunch-c2-2">Starting soon...</div>
          <div className="cdlaunch-c2-3">
            <CountdownTimer count={1664582400 + 86400 * 18 - parseInt(Date.now() / 1000)} onEnd={() => {}} />
          </div>
          <div
            className="cdlaunch-c2-faucet hover mobile_none"
            onClick={() => {
              window.navigator.clipboard.writeText('0x4D9927a8Dc4432B93445dA94E4084D292438931F');
            }}
          >
            <img src={logo} alt="arrow icon" />
            <span className="white"> BNBP </span> 0x4D9927a8Dc4432B93445dA94E4084D292438931F{' '}
            <img src={copyyellow} alt="arrow icon" />
          </div>
        </div>
        ...
        <div
          className="cdlaunch-c2-faucet hover desktop_none"
          style={{ background: '#454753' }}
          onClick={() => {
            window.navigator.clipboard.writeText('0x4D9927a8Dc4432B93445dA94E4084D292438931F');
          }}
        >
          <img src={logo} alt="arrow icon" />
          <span className="white"> BNBP </span>{' '}
          {'0x4D9927a8Dc4432B93445dA94E4084D292438931F'.substring(0, 7) +
            '...' +
            '0x4D9927a8Dc4432B93445dA94E4084D292438931F'.slice(-7)}{' '}
          <img src={copyyellow} alt="arrow icon" />
        </div>
        <div className="cdlaunch-c1 desktop_none">
          <div
        ...
        <div className="cdlaunch-c1 desktop_none">
          <div className="hover">
            <a
              href="https://dexscreener.com/bsc/0x4c736d24d72d874cc2465553500c1ff3fc7b3bda"
              target="_blank"
              style={{ background: '#454753' }}
            >
              Chart
          ...
          <div className="hover">
            <a
              href="https://bscscan.com/token/0x4D9927a8Dc4432B93445dA94E4084D292438931F"
              target="_blank"
              style={{ background: '#454753' }}
            >
              Explorer
