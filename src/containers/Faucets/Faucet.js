...
export default function Faucet(props) {
  ...
  return (
    <div className="card Faucet Page">
      <div className="page_title underline-yellow">Faucet</div>
      <div className="faucet_page_content">
        <div>
          This BNB Faucet will provide <span className="white">0.01BNB</span>
          <br />
        ...
        <div className="faucet_container">
          <div className="faucet_content2">
            ...
            <input
              type="text"
              placeholder="Insert wallet address here..."
              id={'faucetAddress'}
              value={faucetAddress}
              onChange={(e) => {
            ...
            {!faucetClaimed ? (
              <div
                className=" faucet_content2_1 hover"
                onClick={() => {
            ...
            <div className="faucet_content2_error">
              {faucetError > 0 ? (
                <div style={{ color: 'red', textAlign: 'center' }}>Error: {faucetError}</div>
              ) : (
                <div></div>
              )}
            </div>
