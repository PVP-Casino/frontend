...
import powerball_inactive from '../../../assets/images/Menu icons/Games section/powerball-inactive.png';
...
import powerball_active from '../../../assets/images/Menu icons/Games section/powerball-active.png';
      ...
      <div className={isMenuOpen ? 'menuItems menuItems_dark' : 'menuItems menuItems_dark mobile_none '}>
        <div className={props.page == 1 ? 'menuItem CurrentGame' : 'menuItem'}>
          ...
          >
            ...
            JACKPOT
            <img src={`/assets/${isMuted ? 'mute' : 'volume'}.png`} alt='volume' onClick={onToggleMute} />
          </Link>
        </div>
        ...
        <div className={props.page == 16 ? 'menuItem CurrentGame' : 'menuItem'}>
          <Link
            to='/powerballroom'
            onClick={() => {
              props.setPage(16);
          ...
          >
            <img src={props.page == 16 ? powerball_active : powerball_inactive} alt='menu item' />
            POWERBALL
          </Link>
        </div>
