...
import allstats from '../../../assets/images/allstats.png';
...
export default function Stats(props) {
  ...
  return (
    <div className='MenuContent Stats'>
      ...
      <div className={isMenuOpen ? 'menuItems' : ' menuItems mobile_none  '} style={{ paddingRight: '10px' }}>
        <div className='menuItem'>
          {/* <a href='/stats/airdrop'> */}
          <a href='#'>
        ...
        <div className='menuItem'>
          ...
          <a href='#'>
            ...
            STAKED
            <div>
              {(props.potInfo.stake * 100).toFixed(2)}%{/* <img src={logo} alt='clock icon' /> */}
            </div>
          </a>
        </div>
        <div className='menuItem'>
          {/* <a href='/stats'> */}
          <a href='#'>
            <img src={allstats} alt='menu item' />
            ALL STATISTICS
            <div>{/* <img src={logo} alt='clock icon' /> */}</div>
          </a>
        </div>
