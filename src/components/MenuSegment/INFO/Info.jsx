  ...
  return (
    <div className='MenuContent Info'>
      ...
      <div className={isMenuOpen ? 'menuItems' : ' menuItems mobile_none  '}>
        <div
          className={props.page == 9 ? 'menuItem CurrentMenuItem' : 'menuItem'}
          onClick={() => {
            props.setPage(9);
        ...
        <div
          className={props.page == 12 ? 'menuItem CurrentMenuItem' : 'menuItem'}
          onClick={() => {
            props.setPage(12);
            props.setShowMenu(false);
          }}
        ...
        <div
          className={props.page == 13 ? 'menuItem CurrentMenuItem' : 'menuItem'}
          onClick={() => {
            props.setPage(13);
            props.setShowMenu(false);
          }}
        ...
        {/* <div
          className={props.page == 14 ? 'menuItem CurrentMenuItem' : 'menuItem'}
          onClick={() => {
            props.setPage(14);
            props.setShowMenu(false);
          }}
        ...
        <div
          className={props.page == 15 ? 'menuItem CurrentMenuItem' : 'menuItem'}
          onClick={() => {
            props.setPage(15);
            props.setShowMenu(false);
          }}
