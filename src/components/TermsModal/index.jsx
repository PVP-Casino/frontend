        ...
        <Box className='terms-modal-container'>
          ...
          >
            ...
            >
              ...
              <p>
                ● Don't treat playing on ZetaPlay as a way to make money - treat it as an entertainment expense;
                <br />
              ...
              <p>
                ZetaPlay is not liable for any possible financial damage arising from the use of the website and
                happened due to the reasons out of control of ZetaPlay
              </p>
              <p>
                ZetaPlay is in no way responsible for any access to a User's account by a third person and will not be
              ...
              <p>
                ZetaPlay is not liable for any hardware or software, defects, unstable or lost Internet connections, or
                any other technical errors that may limit User’s access to the website.
              </p>
              <p>ZetaPlay, its directors, employees, partners, service providers:</p>
              <p>
                ...
                <br />
                <br />
                4. You agree that ZetaPlay shall be the final decision-maker of whether you have violated the ZetaPlay
                ...
                <br />
                <br />
                6. Except as otherwise required by law, in no event ZetaPlay, our directors, members, employees or
                agents shall be liable for any special, indirect or consequential damages, or any other damages of any
                ...
                connected with the use of or inability to use our services or the ZetaPlay materials, including without
                limitation any damages caused by or resulting from reliance by any user on any information obtained from
                ZetaPlay, or actions on the website or that result from mistakes, omissions, interruptions, deletion of
                ...
                unauthorized access to ZetaPlay records, programs or services.
                <br />
                <br />
                ...
                <br />
                <br />
                8. ZetaPlay is not responsible for any damages caused by delay or failure to perform its obligations
                under the agreement if the said delay or failure is due to fires; strikes; floods; power outages or
                failures; acts of god or the state’s enemies; lawful acts of public authorities; any and all acts that
                are regarded as force majeure in legal practice.
                <br />
                <br />
              </p>
              <p>
                <strong>Eligibility to use ZetaPlay’s services</strong>
              </p>
              <p>
                ...
                <br />
                <br />
                2. The User assures ZetaPlay that he/she is over 18 years old or such legal age of majority as
                stipulated in the jurisdiction of his/her residence. We may require you to provide proof of age. User
                must be a natural individual, not a legal entity or corporate body. The User must be able to enter into
                legally binding contracts. The User must reside in countries and geographic regions where the Services
                are allowed by law. The User must not reside in Washington state.
                <br />
                ...
                its services. ZetaPlay will make all reasonable efforts to prevent players from these countries from
              ...
              <p>
                This website is provided “as is” without any representations or warranties, express or implied. ZetaPlay
                makes no representations or warranties in relation to this Site or the information and materials
                provided on the Site. Without prejudice to the generality of the foregoing paragraph, ZetaPlay does not
